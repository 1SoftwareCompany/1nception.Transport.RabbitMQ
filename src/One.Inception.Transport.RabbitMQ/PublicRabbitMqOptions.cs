...
public class PublicRabbitMqOptionsProvider : InceptionOptionsProviderBase<PublicRabbitMqOptionsCollection>
{
    public const string SettingKey = "Inception:transport:publicrabbitmq";
